        ...
        <div class="card shadow-lg border-0 rounded-3">
          <div class="card-body text-center p-4">
            ...
            <div class="row text-center mb-3">
              <div class="col-4"><h5 class="text-primary mb-1">{{ stats.totalPosts }}</h5><small class="text-muted">Posts</small></div>
              <div class="col-4"><h5 class="text-success mb-1">{{ stats.comments }}</h5><small class="text-muted">Comments</small></div>
              <div class="col-4"><h5 class="text-info mb-1">{{ stats.likes || 0 }}</h5><small class="text-muted">Likes</small></div>
            </div>
          ...
          <div class="card-body p-4">
            <form @submit.prevent="updatePersonalInfo">
              ...
              <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-primary" :disabled="loading.personal || !isPersonalFormValid">
