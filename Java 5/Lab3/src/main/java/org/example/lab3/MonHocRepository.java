...
public class MonHocRepository {
    ...
    static {
        monHocs.add(new MonHoc("MH001", "Buôn bán máy bay", 4, "Digital Marketing", List.of("MinhDQ8", "DungNA29"), true));
        ...
        monHocs.add(new MonHoc("MH004", "Ferrari", 3, "Ô tô cơ khí", List.of("NguyenVV4", "TienNH21"), false));
    }
