create database DuAnTotNghiepJava
go
use DuAnTotNghiepJava
--1
...
VALUES
(3, 1, 1, 1, 1, 3,  '2025-03-10', N'Trả đúng hạn', N'Tốt'),
(4, 2, 2, 2, 2, 12,  '2025-03-11', N'Mất sách', N'Mất'),
(5, 3, 3, 3, 3, 19,  '2025-03-12', N'Bìa sách bị rách', N'Hỏng');
