...
public class Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (uri.contains("hien-thi")) {
            ...
            LoginUI(req, resp);
        } else if (uri.contains("api/sanpham/get-all")) {
            Ajax(req, resp);
    ...
    public void HienThi(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("listSP", repository.getLoaiSp());
    ...
    public void Add(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Integer idSp = Integer.valueOf(req.getParameter("idSp"));
        LoaiSp loaiSp = repository.getLoaiSpID(idSp);
    ...
    public void Login(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (username == null || username.isBlank() || password == null || password.isBlank()) {
            ...
            req.getRequestDispatcher("/login.jsp").forward(req, resp);
            return;
        } else if (!username.equals("phongndth03089") || !password.equals("123456")) {
